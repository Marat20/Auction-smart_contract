...
async function main() {
  if (network.name === 'hardhat') {
    console.warn(
      `You are trying to deploy a contract to the Hardhat Network, which gets automatically created and destroyed every time. Use the Hardhat option'--FBtwork localhost'`
    );
  }
